...
export const data = {
  instagram: 'https://www.instagram.com/krisha.crafts/',
  facebook: 'https://www.facebook.com/krishacraft',
  address: 'Near TU Gate, Balkhu',
  city: 'Kathmandu',
  openDays: 'Monday - Friday',
  openTime: '08:00 AM - 05:00 PM',
  email: 'krishacrafts@gmail.com',
  phone: '+977 984-1651233',
};
...
export const categories = ['All', 'Decorative', 'Traditional'];
